<?php 
    ...
    echo'<form action="reponse5Verif.php" method="POST">';
    echo "<h3>effectuer un OUlogique entre ces deux nombres écrit en binaire et donez le résultat</h3><br>";
    echo '<table class="table">
        ...
        <tbody>
            <tr>
                <td>
                    <input type="text" name="question5a">
                </td>
            </tr>
        </tbody>
    </table>';
    ...
    echo '<table class="table">
        <tbody>
            <tr>
                <td>
                    <input type="text" name="question5b">
                </td>
            </tr>
        </tbody>
    </table>';
